...
const Tap = () => {
  ...
  const [currentCashpPrice, setCurrentCashpPrice] = useState();
  const [currentCashpBalance, setCashpBalance] = useState();
  const [currentClaimAmount, setClaimAmount] = useState();
  ...
  useEffect(async () => {
    if (account) {
      const balance = await getAccCashpBalance();
      setCashpBalance(balance);

      const price = await getCashpPrice();
      setCurrentCashpPrice(price);

      const claim = await getCurrentClaimAmount();
      setClaimAmount(claim);

      const totalclaim = await getTotalClaimAmount();
      setTotalClaimAmount(totalclaim);

      const totaldeposit = await getTotalDepositAmount();
      ...
      <div className="container">
        <Grid container justifyContent="center">
          <Grid item xs={6} sm={4} md={4}>
            <div className="stats_card_grp_well tap_card_grp">
              ...
              <div className="stats_card_text_number_well">
                ...
                <div>$ &nbsp;
                  {
                    currentCashpPrice >= 0 && currentClaimAmount >= 0 ? currentCashpPrice * currentClaimAmount : "Fetching..."
                  }
                </div>
              </div>
            </div>
          ...
          <Grid item xs={6} sm={4} md={4}>
            <div className="stats_card_grp_well tap_card_grp tap_card_grp">
              <div className="stats_card_avatar">
                <img
                  src={img_logo}
                  alt="logo"
              ...
              <div className="stats_card_text_number_well">
                ...
                <div>$ &nbsp;
                  {
                    currentCashpPrice >= 0 && totalDepositAmount >= 0 ? currentCashpPrice * totalDepositAmount : "Fetching..."
                  }
                </div>
              </div>
            </div>
          ...
          <Grid item xs={6} sm={4} md={4}>
            <div className="stats_card_grp_well tap_card_grp">
              ...
              <div>
                  {
                    totalClaimAmount >= 0 ? totalClaimAmount : "Fetching.."
                  } &nbsp; CashP
                </div>
                <div>$ &nbsp;
                  {
                    currentCashpPrice >= 0   && totalClaimAmount  >= 0 ? currentCashpPrice * totalClaimAmount : "Fetching..."
                  }
                </div>
              </div>
            </div>
            ...
            <Grid item xs={12}>
              ...
              <div className="btn_format">
                <button
                  ...
                  disabled={currentClaimAmount <= 0 || isCompounding}
                >
                  <svg
                    stroke="currentColor"
                    fill="currentColor"
                ...
                <button
                  ...
                  disabled={currentClaimAmount <= 0 || isClaiming}
                >
                  <svg
                    stroke="currentColor"
                    fill="currentColor"
          ...
          <Tabs>
            ...
            <TabPanel>
              ...
              >
                <Grid item xs={12} sm={4} md={4}>
                  ...
                  >
                    CashPrice : $&nbsp;
                    {
                      currentCashpPrice ? currentCashpPrice : "Fetching..."
                    }
                  </div>
                </Grid>
                <Grid item xs={12} sm={4} md={4}>
                ...
                <Grid item xs={12} sm={4} md={4}>
                  ...
                  >
                    Balance :<span>
                      {
                        currentCashpBalance >= 0 ? currentCashpBalance : "Fetching..."
                      }
                      &nbsp;CASHP
                    </span>
                  </div>
              ...
              >
                ...
                >
                  {
                    isDepositing ? "Please wait ..." : "DEPOSITE"
                  }
                </button>
              </Grid>
            </TabPanel>
